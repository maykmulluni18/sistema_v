...
const FilterDataEdit2 = () => {
   ...
   /* const rr=useCallback(()=>{
    ...
    return (
        <>
            <datalist className='datalistt' id="datap2">

                {
                    administrativos
                        .map(res => {
                            return (
                                <option className='options' key={res.id} value={res.nombres + ' ' + res.apellido_paterno + ' ' + res.apellido_materno}>'
                                    {res.nombres}' '
...
export default React.memo(FilterDataEdit2)